...
func TestCase1(t *testing.T) {
	...
	flags := MyFlags{N: false, K: -1, R: false, U: false}
	Sort(&strings, flags)
	res := ""
...
func TestCase2(t *testing.T) {
	strings := strings.Split(TestString, "\n")
	flags := MyFlags{N: false, K: 8, R: false, U: false}
	Sort(&strings, flags)
	res := ""
	for _, s := range strings {
		res += s + "\n"
...
func TestCase3(t *testing.T) {
	strings := strings.Split(TestString, "\n")
	flags := MyFlags{N: true, K: 6, R: false, U: false}
	Sort(&strings, flags)
	res := ""
	for _, s := range strings {
		res += s + "\n"
...
func TestCase4(t *testing.T) {
	strings := strings.Split(TestString, "\n")
	flags := MyFlags{N: true, K: 6, R: true, U: false}
	Sort(&strings, flags)
	res := ""
	for _, s := range strings {
		res += s + "\n"
...
func TestCase5(t *testing.T) {
	strings := strings.Split(TestString, "\n")
	flags := MyFlags{N: true, K: 6, R: true, U: true}
	Sort(&strings, flags)
	res := ""
	for _, s := range strings {
		res += s + "\n"
