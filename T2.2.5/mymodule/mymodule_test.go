...
var TestCase1flags=My_flags{1,0,0,false,false,false,false,false}
var TestCase2flags=My_flags{0,0,2,false,true,false,true,false}
var TestCase3flags=My_flags{0,0,2,false,true,true,true,false}
var TestCase4flags=My_flags{0,0,2,true,true,true,true,false}
...
func TestCase1(t *testing.T) {
	res:=Grep(TestString,requestString,TestCase1flags)
	if res!=TestString1{
		t.Error("expected\n", TestString1,"\n","got\n", res)
	}
}
...
func TestCase2(t *testing.T) {
	res:=Grep(TestString,requestString,TestCase2flags)
	if res!=TestString2{
		t.Error("expected\n", TestString2,"\n","got\n", res)
	}
}
...
func TestCase3(t *testing.T) {
	res:=Grep(TestString,requestString,TestCase3flags)
	if res!=TestString3{
		t.Error("expected\n", TestString3,"\n","got\n", res)
	}
}
...
func TestCase4(t *testing.T) {
	res:=Grep(TestString,requestString,TestCase4flags)
	if res!=TestString4{
		t.Error("expected\n", TestString4,"\n","got\n", res)
	}
}
